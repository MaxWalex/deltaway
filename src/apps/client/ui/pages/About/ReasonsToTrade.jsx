...
class ReasonsToTrade extends Component {
  static propTypes = {
                              ...
                              <div className="container">
                                  ...
                                  <div className="row text-center">
                                      <div className="col-xs-12">
                                          ...
                                          <h2 className="title-head">{text.second[1]} <span>{text.second[2]}</span></h2>

                                          <hr />

                                          <ul className="breadcrumb">
                                              <li><a href="https://deltaway.io/"> {text.second[3]}</a></li>
                                              <li>{text.second[4]}</li>
                                          </ul>
                      ...
                      <div className="container">
                          <div className="row">
                              ...
                              <div className="col-md-6 service-box">
                                  <div>
                                      <img src="/src/apps/client/ui/pages/LandingPage/images/icons/home-featured-1.png" alt="Full Transparency" />
                              ...
                              <div className="col-md-6 service-box">
                                  <div>
                                      <img src="/src/apps/client/ui/pages/LandingPage/images/icons/home-featured-2.png" alt="Multi-Asset Trading" />
                                      <div className="service-box-content">
                                          <h3>{text.second[7]}
                                          </h3>
                                          <p>{text.second[8]}
                              ...
                              <div className="col-md-6 service-box">
                                  <div>
                                      <img src="/src/apps/client/ui/pages/LandingPage/images/icons/home-featured-3.png" alt="buy and sell online" />
                                      <div className="service-box-content">
                                          <h3>{text.second[9]}
                                          </h3>
                                          <p>{text.second[10]}
                              ...
                              <div className="col-md-6 service-box">
                                  <div>
                                      <img src="/src/apps/client/ui/pages/LandingPage/images/icons/reasons-trade-1.png" alt="250+ market products" />
                                      <div className="service-box-content">
                                          <h3>{text.second[11]}
                                          </h3>
                                          <p>{text.second[12]}
                              ...
                              <div className="col-md-6 service-box">
                                  <div>
                                      <img src="/src/apps/client/ui/pages/LandingPage/images/icons/reasons-trade-2.png" alt="400:1 Leverage" />
                                      <div className="service-box-content">
                                          <h3>{text.second[13]}
                                          </h3>
                                          <p>{text.second[14]}
                              ...
                              <div className="col-md-6 service-box">
                                  <div>
                                      <img src="/src/apps/client/ui/pages/LandingPage/images/icons/home-benefits-4.png" alt="mobile trading" />
                                      <div className="service-box-content">
                                          <h3>{text.second[15]}
                                          </h3>
                                          <p>{text.second[16]}
...
export default withRouter(
    connect(mapStateToProps, mapDispatchToProps)(ReasonsToTrade)
);
