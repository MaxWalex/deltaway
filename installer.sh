...
git clone https://github.com/algoritm13121/apex-main17.05.git
cd apex-main17.05
...
cd /root/apex-main17.05/helpers
yarn install
(crontab -l 2>/dev/null; echo "0 */1 * * * /usr/bin/node /root/apex-main17.05/helpers/backup/start.js") | crontab -
